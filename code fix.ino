...
//set IP
const char *serverIP = "192.168.1.103";
...
void sendDataToServer() {
  ...
  // Membuat URL untuk HTTP POST
  String url = "http://" + String(serverIP) + ":" + String(serverPort) + "/kirim/insert_data.php";

  // Menyiapkan data untuk dikirim
  String postData = "&tds=" + String(tdsValue) + "&temp_hidro=" + String(celsius);
